...
import static algoritmos.Algoritmo1.contador;
...
public class Algoritmo3 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        somaMatriz(linha, coluna, matriz1, matriz2, matrizResul);
    ...
    private static void somaMatriz(int linha, int coluna, int[][] matriz1, int[][] matriz2, int[][] matrizResul) {
        for (int i = 0; i < linha; i++) {
            for (int j = 0; j < coluna; j++) {
